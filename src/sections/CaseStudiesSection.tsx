    ...
    <section id="case-studies" className="w-full bg-navy-900 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        ...
        >
          ...
          <Link
            to="/case-studies"
            className="mt-4 sm:mt-0 text-sm font-medium text-slate-400 hover:text-white flex items-center gap-2 transition-colors duration-200"
          >
          ...
          {caseStudies.map((cs) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link
                  to="/case-studies"
                  className="inline-flex items-center gap-2 text-sm font-medium text-slate-300 group-hover:text-purple transition-colors duration-200"
                >
                  View Case Study
